    ...
    return (
        <div className="w-full min-h-screen px-6 py-20 bg-custom-background font-english text-custom-text">
            ...
            <div className="flex flex-col justify-center gap-4 m-auto max-w-3xl text-custom-text">
                <button className="group flex items-center justify-between py-6 px-6 rounded-2xl border border-custom-border-hover bg-custom-secondary text-left transition-all duration-200 hover:cursor-pointer hover:-translate-y-1 hover:border-custom-primary hover:bg-custom-secondary-hover">
                    <div>
